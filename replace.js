const fs = require('fs');
let content = fs.readFileSync('client/src/pages/AdminDashboardPage.jsx', 'utf8');
const oldStrStart =         {activeTab === 'reports' && (
          <div className=" bg-white rounded-2xl shadow-sm p-12 text-center\>;
const idx = content.indexOf(oldStrStart);
if (idx !== -1) {
 ...
 content = content.substring(0, idx) + newStr + content.substring(endIdx + 2);
 fs.writeFileSync('client/src/pages/AdminDashboardPage.jsx', content);
